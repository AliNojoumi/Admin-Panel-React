...
export default function Dashboard(props) {
    ...
    const [date, setDate] = useState({
        hourTime: 0, minTime: 0, secTime: 0, yearTime: 0, monTime: 0, dayTime: 0,
    });
    ...
    return (<section className={style["dashboard-container"]}>
        ...
        <div
            ...
            <div className={style["dashboard-banner"]}>
                <div className={style["time-box"]}>{date.hourTime} : {date.minTime} : {date.secTime}</div>
                <div className={style["date-box"]}>{date.yearTime} / {date.monTime} / {date.dayTime}</div>
            </div>
        </div>
    </section>);
}